...
const ItemDetailsSkeleton = () => (
  <div className="mx-auto mt-[70px] mb-[60px] max-w-[900px] rounded-[10px] bg-white p-4 shadow-[0_4px_15px_rgba(0,0,0,0.05)]">
          ...
          reviews.map(
            (
              ...
              >
                ...
                {review.comment && (
                  <p className="mb-3 ml-3 leading-6 text-gray-800">
                    {review.comment}
                  </p>
                )}
